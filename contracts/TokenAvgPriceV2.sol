...
contract TokenAvgPriceV2 is OwnableUpgradeable, PausableUpgradeable {
    ...
    function setTokenPriceForDay(uint256 _dayTimestamp, uint256 _price) external onlyOwner returns(bool) {
