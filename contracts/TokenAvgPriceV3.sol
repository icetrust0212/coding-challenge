...
contract TokenAvgPriceV3 is OwnableUpgradeable, PausableUpgradeable {
    ...
    function setTokenPriceForDay(uint256 _dayTimestamp, uint256 _price) external returns(bool) {
        ...
        console.log("time: ", _day == block.timestamp.div(86400));

        require(_day == block.timestamp.div(86400), "The price of a token on a day can be set on the same day itself.");
